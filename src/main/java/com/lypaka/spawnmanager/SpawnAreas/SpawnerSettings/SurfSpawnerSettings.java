...
public class SurfSpawnerSettings {
    ...
    public SurfSpawnerSettings (boolean autoBattle, List<String> blockIDs, boolean despawnAfterBattle, Map<String, String> messagesMap, boolean preventCobblemonSpawns,
                                double spawnerShinyChance, double spawnChance, int spawnLimit, int spawnRadius) {
